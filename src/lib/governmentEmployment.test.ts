...
describe('prior government employment, answered from the experience bank', () => {
  ...
  test('target-free sibling fields use the same complete parsers for answer and refresh', () => {
    ...
    const priorLabels = [
      ...
      'Have you applied to our organization before?',
      'Did you apply to this organization previously?',
      'Have you applied to current organization?',
      'Have you applied to the organization last month?',
      'Did you apply to the current organization within the last month?',
      'Have you applied to our organisation?',
      'Did you apply to this organisation in the past?',
      'Have you applied to current organisation ever?',
      'Have you applied to the organisation in the past 6 months?',
      'Did you apply to the current organisation over the past 6 months?',
      'Have you applied to our firm before?',
      'Did you apply to this firm previously?',
      'Have you applied to current firm?',
      'Have you applied to the firm over last 6 months?',
      'Did you apply to the current firm within the past 6 months?',
      'Have you applied to our business within the last 30 days?',
      'Did you apply to this business in the last 2 weeks?',
      'Have you applied to current business in the past?',
      'Have you applied to the business in the last year?',
      'Did you apply to the current business over the last 1-2 years?',
      'Have you applied to our institution ever?',
      'Did you apply to this institution within the last 6 months?',
      'Have you applied to current institution before?',
      'Have you applied to the institution past week?',
      'Did you apply to the current institution in past 2 weeks?',
      'Have you applied to our agency in the last 1 year?',
      'Did you apply to this agency ever?',
      'Have you applied to current agency previously?',
      'Have you applied to the agency within last year?',
      'Did you apply to the current agency over past 3 months?',
      'Applied here before',
      ...
      'Have you applied for employment here?',
      ...
      'Have you applied for employment with this organization?',
      'Did you apply for work at our firm?',
      'Have you applied for employment with current company?',
      'Did you apply for work at this employer?',
      'Previous applicant',
    ];
    ...
    const globalPriorLabels = [
      ...
      'Have you applied for work before?',
    ];
    ...
    for (const declared of [['Other Corp'], []] as const) {
      for (const label of [
        ...
        'Have you applied for a clinical residency?',
        'Did you apply for graduate schemes?',
      ]) {
        const profile: ApplicationProfileLike = { prior_application_employers: [...declared] };
        const held = resolveKnownAnswer(label, 'text', profile, context);
        assert.ok(held && 'skipReason' in held, label);
      ...
      for (const label of [
        ...
        'Have you submitted the final external complete application?',
        'Have you submitted the formal employment application?',
        'Did you submit your electronic job application?',
        'Submitted this required job application',
        'Have you submitted the candidate application?',
        ...
        'Have you applied to our product function?',
        'Did you apply to the Acme product function?',
        'Have you applied to our consulting practice?',
        'Did you apply to the Acme consulting practice?',
        'Have you applied to the product function?',
        'Did you apply to a consulting practice?',
        'Have you applied to the corporate finance function?',
        'Have you applied to product functions?',
        'Did you apply to our advisory functions?',
        'Have you applied to Acme business development practices?',
        'Did you apply to client services practices?',
        'Have you applied to organizational functions?',
        'Did you apply to our consulting practices?',
        'Have you applied to this risk function?',
        'Did you apply to current compliance practices?',
        'Have you applied to Acme operations functions?',
        'Have you applied to the risk function?',
        'Did you apply to compliance practices?',
        'Have you applied to human resources functions?',
        'Did you apply to our HR practice?',
        'Have you applied to people functions?',
        'Did you apply to this talent practice?',
        'Have you applied to recruiting functions?',
        'Did you apply to sales practices?',
        'Have you applied to our marketing function?',
        'Did you apply to customer success practices?',
        'Have you applied to Acme customer support functions?',
        'Did you apply to supply chain practices?',
        'Have you applied to procurement functions?',
        'Did you apply to our accounting practice?',
        'Have you applied to treasury functions?',
        'Did you apply to investor relations practices?',
        'Have you applied to our communications function?',
        'Did you apply to public relations practices?',
        'Have you applied to security governance functions?',
        'Did you apply to quality assurance practices?',
        'Have you applied to our program management function?',
        'Did you apply to Acme project management practices?',
        'Have you applied to the IT function?',
        'Did you apply to our information technology practice?',
        'Have you applied to the commercial function?',
        'Did you apply to Acme regulatory affairs practices?',
        'Have you applied to the corporate development function?',
        'Did you apply to research and development practices?',
        'Have you applied to our R&D function?',
        'Did you apply to partnership practices?',
        'Have you applied to business operations functions?',
        'Did you apply to our revenue operations practice?',
        'Have you applied to the go-to-market function?',
        'Did you apply to Acme strategy and operations practices?',
        'Have you applied to the clinical operations function?',
        'Did you apply to our data privacy practice?',
        'Have you applied to Acme medical affairs functions?',
        'Did you apply to the ESG practice?',
        'Have you applied to environmental social governance functions?',
        'Did you apply to our environmental and social governance practice?',
        'Have you applied for a senior role within our risk function?',
        'Did you apply to the position in the compliance practice at Acme?',
        'Have you applied for an opening at the operations function in Boston?',
        'Have you applied for another fixed-term graduate post?',
        'Did you apply to graduate posts?',
        'Have you applied for another appointment?',
        'Did you apply to fixed-term appointments?',
        'Have you applied for a graduate contract?',
        'Did you apply to any fixed-term contracts?',
        'Have you applied for another fixed-term post within our risk function?',
        'Did you apply to a graduate appointment in the data privacy practice?',
        'Have you applied to another graduate contract at the medical affairs function?',
        'Did you apply for fixed-term contracts within our ESG practice?',
        ...([
          ...
          ['contract', 'contracts'],
        ] as const).flatMap(([singular, plural], index) => {
          const unit = ['clinical operations', 'data privacy', 'medical affairs', 'esg'][index % 4];
          return [
            `Have you applied for a senior ${singular} in the ${unit} function?`,
            `Did you apply to any ${plural} within our ${unit} practice?`,
          ];
        }),
        'Have you applied to the finance function?',
        'Did you apply to legal practices?',
        'Have you applied to tax functions?',
        'Did you apply to audit practice?',
        'Have you applied to strategy functions?',
        ...
        'Have you applied to the engineering team located at Boston?',
        'Did you apply to the research division within Acme?',
        'Did you apply to the research division for Acme?',
        'Have you applied to the engineering team based at Acme?',
        'Have you applied to the engineering team based at Boston?',
        ...
        'Have you applied for temporary employment?',
        'Did you apply for full-time work in the past?',
        'Have you applied for seasonal employment previously?',
        'Have you applied for summer employment with Acme?',
        'Did you apply for contract work here?',
        'Have you applied for temporary work with this company?',
        'Did you apply for full-time employment at Acme?',
        'Have you applied for summer employment for Acme?',
        'Did you apply for contract work for this organization?',
        'Have you applied to this company recently?',
        'Did you apply to our organization currently?',
    ...
    for (const unrelated of [
      ...
      'Have you submitted the tax application?',
      'Did you submit your housing application?',
      'Have you submitted this insurance application?',
      'Submitted the scholarship application',
      'Have you submitted the tax job application?',
      'Did you submit your housing employment application?',
      'Submitted the insurance candidate application',
      ...
      'Did you apply to business analytics functions?',
      'Have you applied to our activation functions?',
      'Did you apply to our secure coding practices?',
      'Have you applied to Acme activation functions?',
      'Have you applied to the activation function?',
      'Did you apply to a secure coding practice?',
      'Have you applied to the loss function?',
      'Have you applied to the objective function?',
      'Did you apply to mathematical functions?',
      'Have you applied to statistical practices?',
      'Did you apply to our programming function?',
      'Have you applied to Acme API practices?',
      'Did you apply to the database function?',
      'Have you applied to algorithmic practices?',
      'Have you applied to our activation function?',
      'Did you apply to Acme secure coding practice?',
      'Have you applied to this objective function?',
      'Did you apply to current statistical practices?',
      'Did you apply to the business secure coding practice?',
      'Have you applied to another machine learning practice?',
      'Have you applied to softmax functions?',
      'Did you apply to our sigmoid function?',
      'Have you applied to Acme ReLU functions?',
      'Did you apply to testing practices?',
      'Have you applied to this DevOps practice?',
      'Did you apply to current engineering practices?',
      'Have you applied to our risk activation function?',
      'Did you apply to Acme compliance coding practice?',
      'Have you applied to this customer support testing practice?',
      'Did you apply to marketing DevOps functions?',
      'Have you applied for a role in the activation function?',
      'Did you apply to a position within our DevOps practice?',
      'Have you applied for a job at Acme engineering function?',
      'Did you apply to an opening in the compliance function at Other Corp?',
      'Have you applied for a role within the operations practice in London?',
      'Have you applied contract law?',
      'Did you apply to contract law?',
      'Have you applied appointment scheduling?',
      'Did you apply to appointment scheduling?',
      'Have you applied post-processing techniques?',
      'Did you apply to post processing algorithms?',
      'Have you applied to subprograms?',
      'Did you apply for matrix decompositions?',
      'Have you applied to logical propositions?',
      'Did you apply for prepositions?',
      'Have you applied to a subcontract?',
      'Did you apply for subcontracts?',
      'Did you apply to the team activation functions?',
      'Have you applied to our team activation functions?',
      'Did you apply to the Acme department coding practices?',
      ...
      'Have you applied to the sales group located at Acme?',
      'Did you apply to the research division for Boston?',
      ...
      'Did you apply for seasonal employment with another firm?',
    ...
    for (const downstreamApplicationLabel of [
      ...
      'Have you applied for remote work at Other Corp?',
    ]) {
