...
//
// Seeded from src/data/h1bSponsors.ts (generated by scripts/build-h1b-sponsors.mjs out of the USCIS
// H-1B Employer Data Hub) by scripts/seed-sponsor-employers.mjs. A table AND a checked-in file
