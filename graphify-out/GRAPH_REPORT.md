...
## Corpus Check
- 86 files · ~72,449 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 352 nodes · 640 edges · 17 communities detected
...
Cohesion: 0.08
Nodes (14): decryptRow(), sendProfile(), assertEncryptionKeyConfigured(), decryptField(), encryptField(), FieldDecryptError, getKey(), buildPacket() (+6 more)
...
Cohesion: 0.33
Nodes (4): config(), createBrowserSession(), getBrowserSession(), request()

### Community 12 - "Community 12"
Cohesion: 0.31
Nodes (4): fillFirst(), fillPortal(), fillReviewedQuestions(), uploadFirst()
