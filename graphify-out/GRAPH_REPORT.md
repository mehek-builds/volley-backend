...
## Corpus Check
- 128 files · ~109,429 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 589 nodes · 1072 edges · 23 communities detected
...
Cohesion: 0.08
Nodes (24): detectedCountryFromRequest(), firstHeader(), persistAssignment(), stickyVariant(), buildLemonSqueezyCheckoutUrl(), createLemonSqueezyCheckout(), isSafeLemonSqueezyCheckoutUrl(), lemonSqueezyApiReady() (+16 more)
