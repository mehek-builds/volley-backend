...
## Corpus Check
- 108 files · ~95,129 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 466 nodes · 857 edges · 20 communities detected
...
Cohesion: 0.06
Nodes (13): deriveEditedTerms(), overlapScore(), terms(), candidateContext(), canGenerateCoverLetter(), generateStoredCoverLetter(), persistCoverLetter(), saveStoredCoverLetter() (+5 more)
